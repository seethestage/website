...
// Bookmarked Shows Dashboard Checkboxes Toggle
document.addEventListener('DOMContentLoaded', () => {
    const masterCheckbox = document.getElementById('bookmarked-shows-checkbox');

    masterCheckbox.addEventListener('change', function() {
        const checkboxes = document.querySelectorAll('#bookmarked-shows-group .checkbox .check');
